...
<style>
body{
background: url("../img/pin_03.png") no-repeat right fixed ;
}
</style>
...
<div class="signinpanel">
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post">
                    <font class="no-margins" style="font-size:22px;">企业登录：</font>
                    <br />
                    <div id="tipId" class="tishi"></div>
                     <input type="text" name="username" id="usernameId" class="form-control email" placeholder="邮箱"/>
					 <input type="password" name="password" id="passwordId" class="form-control pword" placeholder="密码">	
                    </br>
                    <a href="#">忘记密码？</a>
                    <br/>
                    <button type="button" id="loginId" id="loginId" class="btn btn-success btn-block">登录</button>
                    <a href="../zhuce/companyzc.jsp"><button type="button" class="btn btn-success btn-block">注册</button></a>
                </form>
            </div>
        </div>
