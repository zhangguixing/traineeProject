...
<style>
body{
background: url("../img/pin_01.png") no-repeat center fixed ;
}
</style>
...
<div class="signinpanel">
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post">
                    <font class="no-margins" style="font-size:22px;">学生登录：</font>
                    <br />
                    <div id="tipId" class="tishi"></div>
                     <input name="username" id="usernameId" class="form-control xuehao" placeholder="学号"/>
					 <input type="password" id="passwordId" name="password" class="form-control pword" placeholder="密码">	
                    </br>
                    <a href="#">忘记密码？</a>
                    <br/>
                    <button type="button" id="loginId" class="btn btn-success btn-block">登录</button>
                    <a href="../zhuce/studentzc.jsp"><button type="button" class="btn btn-success btn-block">注册</button></a>
                </form>
            </div>
        </div>
