...
<script type="text/javascript">
	function uploadImage(){
		if(${businessInfo.image!='face.png' }){
			$("#imageForm").submit();
		}
	}
	//修改信息
			...
			<div class="row clearfix" style="height: 580px;">
		        <div class="col-md-5 column" style="-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);border:#EDEFF0 solid;border-width:3px; background-color: #FFFFFF;margin:25px 60px 30px 285px;">
			        <div style="float:inherit">
			 		   ...
			 		   <input type="hidden" name="business.id" value="${businessInfo.id }" />
			 		   <input type="hidden" name="business.image" value="${businessInfo.image }" />
			 			<table class="table table-hover" style="font-size: 14px;">
							...
							<tbody>
								<!-- <tr>
									...
									<td><span style="margin: 0 0px 0px 20px;">小明</span></td>
									
								</tr> -->
								<tr>
						     		<td style="vertical-align: middle;">
									<span class="p13-999" >公司名称</span>				
									</td>
							     <td>
							    	<div id="tijiaoxingming">
								    	<div class="col-sm-9">
								      		<input type="text"  name="business.name" class="form-control input-sm" value="${businessInfo.name }" placeholder="请输入用户名">
								    	</div>
							    	</div>
							    ...
							    <tr>
							        <td style="vertical-align: middle;">
							    	<span class="p13-999" >邮箱</span>
							    	</td>
							    	<td>
							    	<!-- 如果邮箱为空 -->
						    	   <div id="youxiang2">
								    	<div class="col-sm-9">
		    								<input type="email" name="business.username" value="${businessInfo.username }" id="email" onblur="funemail();"  class="form-control input-sm" placeholder="请输入email"/><span id="sp5"></span>
								    	</div>							    	
							    	</div>
								    </td>
							     </tr>
						         <tr>
								   ...
								   <td>
								   <div class="col-sm-9">
		   							<input type="password" name="business.password" id="psd1" value="${businessInfo.password }" onblur="funpsd();" class="form-control input-sm" placeholder="请输入密码"/><span id="sp1"></span>
						           </div>
						           </td>
						         </tr>
							</tbody>
				...
				<div  class="col-md-4 column" > 
					<img src="${pageContext.request.contextPath }/images/${businessInfo.image }" style="border-radius: 50%;width: 150px;height: 150px;margin:37px 0px 20px 7px;" />
