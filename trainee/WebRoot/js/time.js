...
//显示时间
//var s=nyear+'年'+nmonth+'月'+nday+'日 '+'星期'+cweekday(nwday)+' '+shapetime(nhrs,nmin,nsec);//s+=" 农历"+lmonth+"月"+lday;农历
document.getElementById("clock").innerHTML=s;

//显示时间
var s=nyear+'年'+nmonth+'月'+nday+'日 '+'星期'+cweekday(nwday);//s+=" 农历"+lmonth+"月"+lday;农历
document.getElementById("clock").innerHTML=s;
